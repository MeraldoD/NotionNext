...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '究乙Meraldo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '努力成为合格的占星师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://meraldo.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Astrology, 博客', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/101707327?spm_id_from=333.337.search-card.all.click', // B站主页
